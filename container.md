...
Quasi tutti i binding vengono registrati all'interno dei [service provider](/documentazione/5.1/providers), sperciò tutti i seguenti esempi dimostrano come usare il container in quel contesto. In ogni modo, non hai alcun bisogno di eseguire il bind delle classi nel container the non dipendono da nessuna interfaccia. Il container non ha bisogno di essere istruito su come costruire questi oggetti, dal momento che può risolvere automaticamente come oggetti "concreti" tramite i servizi di riflessione di PHP.
...
Infine, ma molto importante, puoi semplicemente fare il "type-hint" di una dipendenza nel costruttore di una classe risolta in automatico dal container, come i [controllers](/documentazione/5.1/controller), gli [event listener](/documentazione/5.1/events), i [job in coda](/documentazione/5.1/coda), i [middleware](/documentazione/5.1/middleware) e altro ancora. In questo modo il container inietta automaticamente le dipendenze.
