...
If you prefer to display the middleware assigned by a group, rather than the group name, you can instruct Laravel to do so by adding the `-vv` option to the command:
