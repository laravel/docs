...
If your Redis server requires password for authentication you can supply one in your database configuration by adding `'password' => 'secret'` to the configuration array.
