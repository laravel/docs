...
With your Vite entry points configured, you only need to reference them in a `@vite()` Blade directive that you add to the `<head>` of your application's root template:
