...
If you use Nginx to serve your Laravel application, here is a sample location configuration which allows us to have nice-looking URLs without `index.php`.
