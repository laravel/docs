...
The current application environment is set using the `APP_ENV` variable inside your `.env` file. You may access this value via the `environment` method on the `App` facade:
