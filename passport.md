...
Then, you may copy [Passport's route file](https://github.com/laravel/passport/blob/11.x/routes/web.php) to your application's `routes` directory and modify them to your liking:
