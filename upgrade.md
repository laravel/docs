...
If you choose to attempt to migrate your application's structure and also choose to remove your application's configuration files, you should install the following compatibility package via Composer to ensure that Laravel continues to function correctly:
