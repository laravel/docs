...
The `lists` method of Eloquent model now returns a `Collection` instance. If you would like to convert the `Collection` into a plain array, use the `all` method:
