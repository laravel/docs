...
Due to underlying changes in the trusted proxy functionality of Symfony HttpFoundation, slight changes must be made to your application's `TrustProxies` middleware located at `App\Http\Middleware\TrustProxies.php`.
