...
> [!WARNING]
> If you are using Docker Desktop for Linux and run into file permission errors within containers, set the `SUPERVISOR_PHP_USER` environment variable to `root`, as described [here](https://github.com/laravel/sail/pull/677#issuecomment-2641741443).
