...
You may then run Reverb's installation command to publish the configuration, add the required environment variables and enable broadcasting in your application:
