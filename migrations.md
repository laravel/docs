...
> **Note:** Dropping or modifying multiple columns within a single migration while using a SQLite database is not supported and will cause exceptions when running or rolling back migrations while executing tests.
