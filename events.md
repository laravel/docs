...
In some cases, you may wish to use a class to handle an event rather than a Closure. Class event listeners will be resolved out of the [Laravel IoC container](/docs/4.1/ioc), providing you the full power of dependency injection on your listeners.
...
You may also use the [Laravel IoC container](/docs/4.1/ioc) to resolve your subscriber. To do so, simply pass the name of your subscriber to the `subscribe` method:
