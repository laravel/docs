...
Typically, listeners are defined as class methods; however, you may also register class or closure based event listeners manually in the `boot` method of your `AppServiceProvider`:
