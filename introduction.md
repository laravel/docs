...
While Laravel is designed for ease of use with the developer in mind, you still need to understand the fundamentals of the PHP language, especially its object and class-oriented aspects. [PHP: The Right Way](http://www.phptherightway.com/) is an easy-to-read, quick reference for PHP popular coding standards with links to authoritative tutorials around the web, and is a good resource if you want to make sure you're up to speed on the modern PHP foundations Laravel is built on.
