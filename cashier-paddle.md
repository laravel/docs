...
> {note} While trialing with payment method up front, Paddle prevents any changes to a subscription like quantity updates or swapping plans. If you want to allow a customer to swap plans during trial you'll have to cancel the subscription first and let them subscribe anew.
