...
This command will publish Fortify's actions to your `app/Actions` directory, which will be created if it does not exist. In addition, FortifyServiceProvider, Fortify's configuration file and migrations will be published.
