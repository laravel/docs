...
The field under validation must be less or equal to than a maximum _value_. Strings, numerics, and files are evaluated in the same fashion as the `size` rule.
