...
> [!NOTE]  
Responses can be extended via macros. The comprehensive [macro](/docs/{{version}}/macroable) documentation includes additional information on the functionality of macros and mixins, as well as their usage.
