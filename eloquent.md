...
The UUID is generated by `Str::orderedUuid()`, which is similar to the [proposed UUID v7](https://datatracker.ietf.org/doc/html/draft-peabody-dispatch-new-uuid-format), can be sorted lexicographically. You can still override both the UUID generation and the Model attributes these should be generated for.
