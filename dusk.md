...
> {tip} If you are using [Laravel Sail](/docs/{{version}}/installation#laravel-sail) to manage your local development environment, please also consult the Sail documentation on [configuring and running Dusk tests](/docs/{{version}}/installation#laravel-dusk).
...
> {tip} If you are using [Laravel Sail](/docs/{{version}}/installation#laravel-sail) to manage your local development environment, please consult the Sail documentation on [configuring and running Dusk tests](/docs/{{version}}/installation#laravel-dusk).
