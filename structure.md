...
- [The App Directory](#the-app-directory)
    ...
    - [The `Http` Directory](#the-http-directory)
      - [The `Controller` Directory](#the-controller-directory)
      - [The `Request` Directory](#the-request-directory)
...
<a name="the-controller-directory"></a>
#### The Controller Directory

The `Controller` directory exists in Http folder and contains your [controllers](https://laravel.com/docs/controllers). All controllers generated by the `make:controller` command exist in this folder.

<a name="the-request-directory"></a>
#### The Request Directory

The `Request` directory exists in Http folder and contains your [requests](https://laravel.com/docs/requests). All requests generated by the `make:request` command exist in this folder.
