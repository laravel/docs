...
The `database` directory contains your model factories, database migration and seeds. If you wish, you may also use this directory to hold an SQLite database.
