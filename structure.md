...
The `Controllers` directory exists in Http folder and contains your [controllers](https://laravel.com/docs/controllers). All controllers generated by the `make:controller` command exist in this folder.
``
<a name="the-requests-directory"></a>
#### The Requests Directory

The `Requests` directory exists in Http folder and contains your [requests](https://laravel.com/docs/requests). All requests generated by the `make:request` command exist in this folder.
