...
You may specify which attributes should be considered data variables using the `@props` directive at the top of your component's Blade template. You may optionally set default values to the attributes. All other attributes on the component will be available via the component's attribute bag:
