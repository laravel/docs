...
Or if you want, you could register your commands in a service provider in the register method. You then just call the commands property instead of defining all the commands in the `$commands` array in the example above. This could possibly be useful when you are creating a package. 
