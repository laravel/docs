...
By default, soft deleted models are not retrieved on your resource routes, and will return a 404 response. You can override this behavior with the `withTrashed` method on your resource route.
