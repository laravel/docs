...
If you wish to cancel a subscription immediately, and invoice remaining un-invoiced metered usage or new/pending proration invoice items, call the `cancelNowAndInvoice` method on the user's subscription:
