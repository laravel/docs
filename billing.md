...
> {note} If your only performs "one-off" charges and does not offer subscriptions. You should not use Cashier. You should use the Stripe and Braintree SDKs directly.
