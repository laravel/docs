...
What if a customer's credit card expires? No worries - the Cashier webhook controller can easily cancel the customer's subscription for you. As noted above, all you need to do is point a route to the controller:
