...
Dopo aver generato il file, puoi utilizzare all'interno delle [view](/documentazione/5.1/view) l'helper `elixir` che è una funzione globale di Laravel che automaticamente caricherà la risorsa corretta:
