...
Note that if you have more than one type of exception handler, the less specific/catch-all ones should be defined first, while the ones targetting specific exception types should be defined last.
