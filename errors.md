...
> {note} Only 500 errors generated by the `abort` function will display the custom error page. Internal server errors generating a 500 error page will still display a "whoops" page.
