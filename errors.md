...
When building your application, there will be some exception types you want to handle with a different exception. Your application's exception handler contains a method to map those exceptions.
