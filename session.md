...
Laravel automatically regenerates the session ID during authentication if you are using one of the Laravel [authentication starter kits](/docs/{{version}}/starter-kits); however, if you need to manually regenerate the session ID, you may use the `regenerate` method.
