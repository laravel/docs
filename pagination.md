...
- [Basic Usage](#basic-usage)
    ...
    - [Customizing Default Pagination](#customizing-default-pagination)
...
<a name="customizing-default-pagination"></a>
### Customizing Default Pagination

The default pagination number is `15`, if you want to change this you can use the `$perPage` property in your own model:
...
Now the default pagination of `User` model is 12.
