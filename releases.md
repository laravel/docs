...
To compliment the new default application structure, `make:event`, `make:provider`, `make:filter`, and `make:request` Artisan commands have been added to the framework.
