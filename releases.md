...
Since PHP 5.5 will enter "end of life" in June and will no longer receive security updates from the PHP development team, Laravel 5.3 requires PHP 5.6.4 or greater. Laravel intends to stick on this version for the foreseeable future. For those looking for PHP 5.5 support, please see our 5.1 LTS series.
