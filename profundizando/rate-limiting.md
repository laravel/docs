...
* [Introduction](rate-limiting.md#introduction)
  * [Cache Configuration](rate-limiting.md#cache-configuration)
* [Basic Usage](rate-limiting.md#basic-usage)
  * [Manually Incrementing Attempts](rate-limiting.md#manually-incrementing-attempts)
  * [Clearing Attempts](rate-limiting.md#clearing-attempts)
