...
If necessary, you may pass another closure as the third parameter, like in the `when` method. This closure will execute if the string does not contain the given value.
...
If necessary, you may pass another closure as the third parameter, like in the `when` method. This closure will execute if the condition parameter evaluates to `false`.
