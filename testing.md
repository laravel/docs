...
You may generate the HTML report too. Here, you'll be able to visualize the lines of code in the HTML view. You'll get the "reports" folder inside of your project and it'll be having .html files of test coverage. It'll show you green lines if the code is being covered by the test cases and red in case if its not.
