...
The `copy` method will flatten the directory's structure by default. If you wish to maintain the directory's original structure, you should pass `false` as the third parameter.
