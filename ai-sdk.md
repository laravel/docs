...
Finally, you should run your application's database migrations. This will create `agent_conversations` and `agent_conversation_messages` tables that the AI SDK uses to power its conversation storage:
