...
If you're using [Laravel Sail](/docs/{{version}}/sail), you'll need to update the container to listen to port defined in `broadcasting.php`. This can be done by adding the following to the `docker-compose.yml` file:
