...
If you want these computed values to be added to the array and JSON representations of your model [you will need to append them](https://laravel.com/docs/5.7/eloquent-serialization#appending-values-to-json).
