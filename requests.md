...
If you would like to disable this behavior, you may remove the two middlewares from your application's middleware stack by removing them from the `$middleware` property of your `App\Http\Kernel` class.
