...
You may attach a cookie to an outgoing `Illuminate\Http\Response` instance using the `cookie` method. You should pass the name, value, and a number of minutes the cookie should be considered valid to this method:
