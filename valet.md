...
For example, if you'd like to use `.localhost` instead of `.dev`, run `valet domain localhost` and Valet will start serving your projects at `*.localhost` automatically.
