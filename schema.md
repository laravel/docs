...
You may also easily drop a foreign key constraint. The default foreign key names follow the <a name="dropping-indexes">same convention</a> as the other indexes created by the Schema builder. Here's an example:
